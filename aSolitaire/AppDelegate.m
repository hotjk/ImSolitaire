...
-(void)loadAllTextures
{
    ...
    [[CCTextureCache sharedTextureCache] addImage:[[DeviceConfig sharedDeviceConfig] homeBatchNodeFileName]];
    ...
    [[CCTextureCache sharedTextureCache] addImage:[[DeviceConfig sharedDeviceConfig] sceneBatchNodeFileName]];
    ...
    [[CCTextureCache sharedTextureCache] addImage:[[DeviceConfig sharedDeviceConfig] cardsBatchNodeFileName]];
    ...
    [[SimpleAudioEngine sharedEngine] preloadEffect:@"drop.caf"];
    [[SimpleAudioEngine sharedEngine] preloadEffect:@"fire.acf"];
...
- (void) removeStartupFlicker
{
    ...
    {
        if ([[DeviceConfig sharedDeviceConfig] isRetina]) 
        {
...
-(void) applicationWillEnterForeground:(UIApplication*)application {
    [[GameLayer sharedGameLayer] cancelTouch];
	[[CCDirector sharedDirector] startAnimation];
}
